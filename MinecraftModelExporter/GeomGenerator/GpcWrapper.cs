...
namespace MinecraftModelExporter.GeomGenerator
{
    ...
    public struct GpcVertex
    {
        ...
        public GpcVertex(double x, double y)
        {
            X = x;
            Y = y;
        }
    ...
    public class GpcVertexList
    {
        public int NofVertices;
        public GpcVertex[] Vertex;

        public GpcVertexList()
        {
        }

        public GpcVertexList(PointF[] p)
        {
            NofVertices = p.Length;
            Vertex = new GpcVertex[NofVertices];
            for (int i = 0; i < p.Length; i++)
                Vertex[i] = new GpcVertex((double)p[i].X, (double)p[i].Y);
        }
    ...
    public class GpcTristrip
    {
        public int NofStrips;
        public GpcVertexList[] Strip;
    }
